 ...
 */
final class Version20210802205304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE property ADD CONSTRAINT FK_8BF21CDED60322AC FOREIGN KEY (role_id) REFERENCES role (id)');
